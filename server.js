...
const questionBanks = {
    quran: {
        easy: [
            ...
            { question: "ما هي أقصر سورة في القرآن الكريم؟", options: ["الإخلاص", "الكوثر", "النصر", "الفلق"], correct: 1 },
        ...
        hard: [
            { question: "أكمل الآية: {أُولئِكَ عَلَيْهِمْ صَلَواتٌ مِنْ رَبِّهِمْ وَ رَحْمَةٌ وَ أُولئِكَ هُمُ...}", options: ["الْمُهْتَدُونَ", "المُفْلِحُونَ", "المُتَقُونَ", "الفَائِزُونَ"], correct: 0 },
            { question: "أكمل الآية: {وَالسَّامِقَاتِ لَهَا طَلْعٌ ...}", options: ["نَضِيدٌ", "ظَهِيرٌ", "مُبِينٌ", "عَظِيمٌ"], correct: 0 },
    ...
    wisdom: {
        easy: [
            ...
            { question: "صديقك من صدقك لا من ...", options: ["صدّقك", "جاملك", "أعطاك", "فارقك"], correct: 0 },
