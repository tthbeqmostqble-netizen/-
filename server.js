...
const questionBanks = {
    quran: {
        easy: [
            ...
            { question: "أكمل الآية: {إِذَا جَاءَ نَصْرُ اللَّهِ وَ...}", options: ["الْفَتْحُ", "الْمَغْفِرَةُ", "النَّصْرُ", "الْبَحْرُ"], answerText: "الْفَتْحُ", surah: "النصر" },
            { question: "أكمل الآية: {تَبَّتْ يَدَا أَبِي لَهَبٍ وَ...}", options: ["تَبَّ", "خَسِرَ", "ضَلَّ", "بَارَ"], answerText: "تَبَّ", surah: "المسد" },
            { question: "أكمل الآية: {قُلْ أَعُوذُ بِرَبِّ ...}", options: ["النَّاسِ", "الْفَلَقِ", "السَّمَاءِ", "الْعَرْشِ"], answerText: "النَّاسِ", surah: "الناس" }
        ],
        hard: [
            ...
            { question: "أكمل الآية: {فَأَصْبَحَ هَشِيمًا ...}", options: ["تَذْرُوهُ الرِّيَاحُ", "مُحْتَضَرًا", "خَامِدًا", "مُنْتَشِرًا"], answerText: "تَذْرُوهُ الرِّيَاحُ", surah: "الكهف" },
            { question: "أكمل الآية: {وَاللَّيْلِ إِذَا يَغْشَى * وَالنَّهَارِ إِذَا ...}", options: ["تَجَلَّى", "سَجَى", "تَلَاهَا", "أَشْرَقَ"], answerText: "تَجَلَّى", surah: "الليل" }
        ]
    }
};
...
io.on('connection', (socket) => {
    ...
    // تعديل إعادة اللعب ليقتصر فقط على صاحب الغرفة (Host)
